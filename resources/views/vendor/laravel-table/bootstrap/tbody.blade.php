                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                @if($table->isRouteDefined('show'))
                                    <form id="show-{{ $model->getKey() }}"
                                        ...
                                        <button{{ classTag('btn', 'btn-link', 'p-0', 'text-primary', 'load-on-click', $model->disabledClasses ? 'disabled' : null) }} type="submit" title="@lang('laravel-table::laravel-table.show')"{{ htmlAttributes($model->disabledClasses ? ['disabled' => 'disabled'] : null) }}>
                                ...
                                @if($table->isRouteDefined('edit'))
                                    <form id="edit-{{ $model->getKey() }}"
                                        ...
                                        <button{{ classTag('btn', 'btn-link', 'p-0', 'text-primary', 'load-on-click', $model->disabledClasses ? 'disabled' : null) }} type="submit" title="@lang('laravel-table::laravel-table.edit')"{{ htmlAttributes($model->disabledClasses ? ['disabled' => 'disabled'] : null) }}>
