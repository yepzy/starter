...
return [
    ...
    */
    ...
    'min' => [
        'numeric' => 'Le champ :attribute doit être supérieur à :max.',
        'file' => 'Le champ :attribute doit peser plus lourd que :max kilo-octet(s).',
        'string' => 'Le champ :attribute doit compter plus de :min caractère(s).',
        'array' => 'Le champ :attribute doit contenir plus de :min élément(s).',
    ],
    ...
    'phone_international' => 'Le champ :attribute est un numéro invalide et devrait être préfixé par un indicatif téléphonique international (exemple : +49 pour l\'Allemagne).',
