...
return [
    ...
    'name' => [
        ...
        'destroy_confirm' => 'Êtes-vous sûr de vouloir supprimer l\'entrée :name ?',
        'destroyed' => 'L\'entrée :name a été supprimée.',
    ],

    'orphan' => [
        'created' => 'L\'entrée :entity > :name a été créée.',
        'updated' => 'L\'entrée :entity > :name a été mise à jour.',
        'destroy_confirm' => 'Êtes-vous sûr de vouloir supprimer l\'entrée :entity > :name ?',
    ...
    'parent' => [
        ...
        'destroy_confirm' => 'Êtes-vous sûr de vouloir supprimer l\'entrée : :parent > :entity > :name ?',
