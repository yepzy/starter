...
return [
    ...
    */
     ...
     */
    'channels' => [ // todo: comment unwanted channels
        'mail',
        'slack',
    ...
    'slack' => ['webhookUrl' => 'https://your-slack-webhook.slack.com'], // todo: customize this value

    // rocket chat webhook example
    'webhook' => ['url' => 'https://rocket.chat/hooks/1234/5678'], // todo: customize this value
