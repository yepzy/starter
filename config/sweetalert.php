...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'alert_auto_close' => env('SWEET_ALERT_MIDDLEWARE_ALERT_AUTO_CLOSE', 8000),
    ...
    */
    ...
    'customClass' => [
        ...
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS', 'btn btn-success mx-2'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS', 'btn btn-secondary mx-2'),
