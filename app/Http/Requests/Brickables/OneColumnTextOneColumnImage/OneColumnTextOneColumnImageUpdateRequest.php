...
class OneColumnTextOneColumnImageUpdateRequest extends FormRequest
{
    /**
     * @return array
    ...
    {
        $rules = [
            'image_right' => app(OneColumnTextOneColumnImageBrick::class)->getMediaValidationRules('images'),
